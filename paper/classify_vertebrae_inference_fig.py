...
TRAIN_DIR = "/home/k.wolcott/NSM/nsm/run_v72" # TO DO: Choose training directory containing model ckpt and latent codes
os.chdir(TRAIN_DIR)
...
mesh_file = "/home/k.wolcott/NSM/nsm/vertebrae_meshes/agamidae_agama_atra_uf180711_01-c3.vtk"
...
shape_completion_results = False # TO DO: Inspect shape completion results? (True or False)
...
def plot_predictions(dim_reduced_coords, similar_ids, similar_coords, novel_coord, filepaths, outfpath, out_fn):
        ...
        plt.savefig(outfpath + "/" + out_fn, dpi=300, bbox_inches='tight')
        plt.close()
####
